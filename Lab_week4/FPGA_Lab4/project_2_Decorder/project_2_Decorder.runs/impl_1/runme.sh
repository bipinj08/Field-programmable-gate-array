...
HD_PWD='C:/Users/User/Desktop/FPGA/FPGA_Lab4/project_2_Decorder/project_2_Decorder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task21.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task21.tcl -notrace
