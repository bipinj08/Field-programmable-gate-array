...
HD_PWD='C:/Users/User/Desktop/FPGA/FPGA_Lab4/project_2_Decorder/project_2_Decorder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task21.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task21.tcl
