...
HD_PWD='C:/Users/User/Desktop/FPGA/FPGA_Lab4/project_1_b/project_1_b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_4_2.tcl -notrace
