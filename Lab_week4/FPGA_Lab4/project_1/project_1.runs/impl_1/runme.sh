...
HD_PWD='C:/Users/User/Desktop/FPGA/FPGA_Lab4/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplexer_4_1_assigning.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multiplexer_4_1_assigning.tcl -notrace
