...
HD_PWD='C:/Users/User/Desktop/FPGA/FPGA_Lab4/project_3_Encorder/project_3_Encorder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log four_two_encorder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source four_two_encorder.tcl -notrace
