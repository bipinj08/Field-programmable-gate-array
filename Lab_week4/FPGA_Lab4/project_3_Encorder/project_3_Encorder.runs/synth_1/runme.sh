...
HD_PWD='C:/Users/User/Desktop/FPGA/FPGA_Lab4/project_3_Encorder/project_3_Encorder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_two_encorder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_two_encorder.tcl
