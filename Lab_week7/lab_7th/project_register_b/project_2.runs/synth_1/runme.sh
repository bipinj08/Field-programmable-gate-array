...
HD_PWD='C:/Users/User/Desktop/FPGA/Lab_Second/lab_7th/project_register_b/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipo_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipo_register.tcl
