...
HD_PWD='C:/Users/User/Desktop/FPGA/Lab_Second/lab_7th/project_register_b/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipo_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pipo_register.tcl -notrace
