...
HD_PWD='C:/Users/User/Desktop/FPGA/Lab_Second/lab_7th/Asynchronous_counter/Asynchronous_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clkdiv_asynccntr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clkdiv_asynccntr.tcl
