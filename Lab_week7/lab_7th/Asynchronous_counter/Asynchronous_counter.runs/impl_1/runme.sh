...
HD_PWD='C:/Users/User/Desktop/FPGA/Lab_Second/lab_7th/Asynchronous_counter/Asynchronous_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clkdiv_asynccntr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clkdiv_asynccntr.tcl -notrace
