...
HD_PWD='C:/Users/User/Desktop/FPGA/FPGA_lab5/project_1_shifter/project_1_shifter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Eight_bit_shifter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Eight_bit_shifter.tcl
