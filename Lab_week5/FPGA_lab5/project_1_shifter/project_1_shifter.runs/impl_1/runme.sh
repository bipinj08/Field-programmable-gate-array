...
HD_PWD='C:/Users/User/Desktop/FPGA/FPGA_lab5/project_1_shifter/project_1_shifter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Eight_bit_shifter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Eight_bit_shifter.tcl -notrace
